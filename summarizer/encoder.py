...
from summarizer.neural import MultiHeadedAttention, PositionwiseFeedForward
from summarizer.rnn import LayerNormLSTM
...
class Classifier(nn.Module):
    ...
    def forward(self, x, mask_cls):
        # x = [batch size, clss length, hidden size]
